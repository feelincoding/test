    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-actions>
            ...
            <v-btn
                ...
                color="deep-purple lighten-2"
                text
                @click="openDecreaseProduct"
            >
                DecreaseProduct
            </v-btn>
            <v-dialog v-model="decreaseProductDiagram" width="500">
                <DecreaseProductCommand
                    @closeDialog="closeDecreaseProduct"
            ...
            <v-btn
                ...
                color="deep-purple lighten-2"
                text
                @click="openIncreaseProduct"
            >
                IncreaseProduct
            </v-btn>
            <v-dialog v-model="increaseProductDiagram" width="500">
                <IncreaseProductCommand
                    @closeDialog="closeIncreaseProduct"
...
<script>
    ...
    export default {
        ...
        data: () => ({
            ...
            decreaseProductDiagram: false,
            increaseProductDiagram: false,
        }),
        created(){
        ...
        methods: {
            ...
            async decreaseProduct(params) {
                try {
                    if(!this.offline) {
                        var temp = await axios.put(axios.fixUrl(this.value._links['decreaseproduct'].href), params)
            ...
            openDecreaseProduct() {
                this.decreaseProductDiagram = true;
            },
            closeDecreaseProduct() {
                this.decreaseProductDiagram = false;
            },
            async increaseProduct(params) {
                try {
                    if(!this.offline) {
                        var temp = await axios.put(axios.fixUrl(this.value._links['increaseproduct'].href), params)
                        for(var k in temp.data) {
                            this.value[k]=temp.data[k];
                        }
                    }
            ...
            openIncreaseProduct() {
                this.increaseProductDiagram = true;
            },
            closeIncreaseProduct() {
                this.increaseProductDiagram = false;
            },
